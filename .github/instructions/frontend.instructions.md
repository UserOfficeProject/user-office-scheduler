...
- Prefer explicit return types (`JSX.Element`, `React.ReactElement`) over `React.FC` for component definitions; use `React.ComponentProps` and other utility types where appropriate
...
12. Document non-obvious logic with JSDoc
